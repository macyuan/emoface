...
import com.ngc123.emoface.activity.PersonalInfoActivity;
import com.ngc123.emoface.adapter.ContactAdapter;
import com.ngc123.emoface.db.InviteMessgeDao;
import com.ngc123.emoface.db.UserDao;
import com.ngc123.emoface.domain.User;
import com.ngc123.emoface.widget.Sidebar;
...
public class ContactlistFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
	    ...
	    rootView.findViewById(R.id.address_book).setEnabled(false);
	    rootView.findViewById(R.id.friends).setEnabled(true);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (Constant.NEW_FRIENDS_USERNAME.equals(username)) {
					...
					// demo中直接进入聊天页面，实际一般是进入用户详情页   已改为进入详情页
				    //startActivity(new Intent(getActivity(), ChatActivity.class).putExtra("userId", adapter.getItem(position).getUsername()));
					startActivity(new Intent(getActivity(), PersonalInfoActivity.class).putExtra("userId", adapter.getItem(position).getUsername()));
				}
			}
		});
