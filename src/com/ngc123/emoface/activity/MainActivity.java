...
import com.ngc123.emoface.db.UserDao;
import com.ngc123.emoface.domain.InviteMessage;
import com.ngc123.emoface.domain.User;
import com.ngc123.emoface.domain.InviteMessage.InviteMesageStatus;
import com.ngc123.emoface.drag.DragLayout;
import com.ngc123.emoface.drag.DragRelativeLayout;
import com.ngc123.emoface.drag.DragLayout.Direction;
import com.ngc123.emoface.drag.DragLayout.OnDragListener;
import com.ngc123.emoface.drag.DragLayout.Status;
import com.ngc123.emoface.utils.CommonUtils;
...
public class MainActivity extends BaseActivity implements EMEventListener,OnClickListener  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragments = new Fragment[] { chatHistoryFragment, contactListFragment, discoverFragment, settingFragment, friendListFragment };
		// 添加显示第一个fragment
    ...
    private void initLeftContent() {
        ...
        mLeftList.setAdapter(new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, MainActivity.sCheeseStrings){
            @Override
